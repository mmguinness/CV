...
| **[Chitter API](https://github.com/mmguinness/frontend-api-challenge)** <img src="./public/MVP_mock_up.png" alt="Chitter" width="80" />                                                                  | A Twitter clone. The backend API is build for you and hosted on Heroku, the task is to build a front-end single-page-app to interface with this API. | Two day solo project   | JavaScript, Jest, HTML, CSS                    |
