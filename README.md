...
| **[Bank Tech test](https://github.com/mmguinness/Bank_tech_test)**  <img src="./public/BankAccount.png" alt="Bank" width="120" />                                                                      | A command line app to emulate a bank account. This is a practice project to demonstrate basic TDD and OOP principles.                                                                                                     | Solo project   | Ruby, RSpec, Rubocop                           |
| **[Chitter API](https://github.com/mmguinness/frontend-api-challenge)** <img src="./public/MVP_mock_up.png" alt="Chitter" width="80" />                                                                  | The backend API is provided for this Twitter clone, the task is to build a front-end single-page-app to interface with this API. | Two day solo project   | JavaScript, Jest, HTML, CSS                    |
